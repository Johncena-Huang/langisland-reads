  ...
  return (
    <>
      <Editor
        value={summary}
        name="summary"
        onEditorChange={(newValue, editor) => handleEditor(newValue)}
        onInit={(evt, editor) => {
        ...
        init={{
          ...
          plugins: "wordcount autosave quickbars link codesample",
          formats: {
            underline: { inline: "u", exact: true },
          },
          toolbar:
            "undo redo | blocks | bold italic |alignleft aligncenter alignright alignjustify | indent outdent |import",
          setup: function (editor) {
            ...
            // Inject markdown into editor after "initialization event"
          },
        }}
      />
      {isInvalid && (
      ...
      <TextEditorContext.Provider value={{ handleEditor }}>
        <NotionPagePicker />
